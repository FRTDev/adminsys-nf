  ...
  return (
    <div className="overflow-x-auto">
      <Table className="text-left">
        <TableHeader className="bg-gradient-to-r from-purple-500/20 to-blue-500/10 backdrop-blur-sm">
          <TableRow className="border-none">
            <TableHead className="font-bold text-white text-lg py-4">Caractéristique</TableHead>
            <TableHead className="font-bold text-white text-lg py-4">Armatis</TableHead>
            <TableHead className="font-bold text-white text-lg py-4">Audilab</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          <TableRow className="border-t border-white/10 hover:bg-white/5 transition-colors">

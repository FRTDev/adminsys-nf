  ...
  return (
    <div>
      ...
      <div className="relative space-y-6 sm:space-y-8">
        <div className="absolute left-5 sm:left-8 top-2 bottom-2 w-px bg-gradient-to-b from-brand/40 via-white/10 to-transparent" />

        <div className="relative ml-12 sm:ml-16">
          <h3 className="text-lg sm:text-2xl font-semibold text-foreground mb-2 flex items-center gap-2 tracking-tight">
        ...
        <div className="relative ml-12 sm:ml-16 pt-6 sm:pt-8">
          <h3 className="text-lg sm:text-2xl font-semibold text-foreground mb-2 flex items-center gap-2 tracking-tight">

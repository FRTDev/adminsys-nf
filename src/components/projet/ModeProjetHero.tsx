      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto animate-fadeIn animation-delay-200">
            Découvrez ma méthodologie de travail en mode projet, l'utilisation d'outils comme Trello et l'application des méthodes agiles pour une gestion efficace des tâches.
          </p>
        </div>
      </div>
    </section>
